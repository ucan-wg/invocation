...
[Invocation] is not executable unless it has authority [Proofs] (in form of UCANs in the `prf` field of its [Task]) and an [Authorization] (in the `auth` field of [Invocation]) from the [Invoker].
...
## 10.3 DAG-JSON Examples

### 10.3.1 Issued by Executor
